...
=== Image files ===
Images files are stored in the data directory. They must be run through the normalize script before they can be used.
normalize.py will normalize (in-place) any files with the given font name and letters A-F
